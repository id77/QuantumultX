const $ = new Env('QR助手', { noLog: true });

let qrData = $.getData('id77_qr_data') || [];
let qrDomClass = $.getData('id77_qr_domClass') || '#qrcode';
...
try {
  let scriptDoms = `<script src="https://unpkg.com/vconsole@3.14.6/dist/vconsole.min.js" ignore></script><script ignore>const _id77_vConsole = new VConsole()</script>`;

  if (!/\/qrcode(.min)?.js/.test(html)) {
    scriptDoms += `
  <script src="https://cdn.jsdelivr.net/npm/davidshimjs-qrcodejs@0.0.2/qrcode.min.js" ignore></script>`;
  }
  ...
  <script ignore>
    ...
    document.addEventListener('dblclick', function (e) {
      const data = _id77_qrData[_id77_qrData_index];
